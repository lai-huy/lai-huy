...
\textbf{Languages} & \textbf{Frameworks \& Libraries} & \textbf{Data \& Messaging} & \textbf{DevOps \& Tools}\\[-7pt]
...
\end{itemize} &
\begin{itemize}[leftmargin=10pt, nosep, topsep=0pt]
    \item Git / Docker / Maven
    \item AWS / GCP
    \item Nginx / Prometheus
    \item Kibana
    \item Firebase / Pub/Sub
    \item VS Code / IntelliJ
\end{itemize}
\end{tabularx}
...
\section{Education}
  \resumeSubHeadingListStart
    ...
    \resumeDegreeheading
      {Texas A\&M University}{College Station, TX}
      {May 2024}{BS in Computer Science, cum laude, Minors: Cybersecurity, Mathematics}
      {3.594}
